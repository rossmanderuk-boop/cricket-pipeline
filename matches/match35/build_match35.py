...
TEAM1_XI = [
    'Glenn Phillips', 'Mavendra Dindyal', 'Shai Hope', 'Mohammad Haris', 'Shimron Hetmyer',
    'Mehidy Hasan Miraz', 'Quentin Sampson', 'Khary Pierre', 'Imran Tahir', 'Romario Shepherd',
    'Shamar Joseph',
]
TEAM2_XI = [
    'Rahkeem Cornwall', 'Evin Lewis', 'Amir Jangoo', 'Hasan Nawaz', 'Moeen Ali', 'Shadab Khan',
    'Fabian Allen', 'Joshua James', 'Sufyan Moqim', 'Alzarri Joseph', 'Shamar Springer',
]
