"""
build_match35.py - CPL 2026, 35th Match, Guyana Amazon Warriors vs Barbados Tridents,
Kensington Oval, Bridgetown, 2026-09-13.
"""
...
INNINGS1_FILE = os.path.join(_HERE, 'innings1.txt')   # Guyana Amazon Warriors (batted first)
INNINGS2_FILE = os.path.join(_HERE, 'innings2.txt')   # Barbados Tridents (chased)

TEAM1_NAME = 'Guyana Amazon Warriors'
TEAM2_NAME = 'Barbados Tridents'

TEAM1_XI = [
    'Glenn Phillips', 'Mavendra Dindyal', 'Shai Hope', 'Shimron Hetmyer',
    'Mehidy Hasan Miraz', 'Dwaine Pretorius', 'Quentin Sampson', 'Romario Shepherd',
    'Ronaldo Alimohamed', 'Imran Tahir', 'Veerasammy Permaul',
]
TEAM2_XI = [
    'Brandon King', 'Zachary Carter', 'Quinton de Kock', 'Sherfane Rutherford',
    'Shadrack Descarte', 'Kevlon Anderson', 'Chris Green', 'George Linde',
    'Gudakesh Motie', 'AM Ghazanfar', 'Johann Layne',
]
...
NAME_MAP = {
    ...
    'Mehidy Hasan Miraz': 'Mehidy Hasan Miraz', 'Miraz': 'Mehidy Hasan Miraz',
    ...
    'Alimohamed': 'Ronaldo Alimohamed', 'Ronaldo Alimohamed': 'Ronaldo Alimohamed',
...
MATCH_INFO = {
    ...
    'city': 'Bridgetown',
    'dates': ['2026-09-13'],
    'event': {'name': 'Caribbean Premier League', 'match_number': 35},
    'gender': 'male',
    'match_type': 'T20',
    'outcome': {'winner': 'Barbados Tridents', 'by': {'wickets': 6}},
    'overs': 20,
    'player_of_match': ['AM Ghazanfar'],
    'season': '2026',
    'team_type': 'club',
...
if __name__ == '__main__':
    out = os.path.join(_HERE, 'cpl_2026_match35_amazon_vs_tridents.json')
