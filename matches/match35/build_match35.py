"""
build_match35.py - CPL 2026, Qualifier 2, Guyana Amazon Warriors vs Jamaica Kingsmen,
Kensington Oval, Bridgetown, 2026-09-18.
"""
...
TEAM1_XI = [
    'Mohammad Haris', 'Mavendra Dindyal', 'Shai Hope', 'Shimron Hetmyer',
    'Quentin Sampson', 'Romario Shepherd', 'Mehidy Hasan Miraz', 'Dwaine Pretorius',
    'Khary Pierre', 'Imran Tahir', 'Shamar Joseph',
]
TEAM2_XI = [
    'Maaz Sadaqat', 'Kirk McKenzie', 'Keacy Carty', 'Saim Ayub', 'Rovman Powell',
    'Andre Russell', 'Hassan Khan', 'Romaine Morris', 'Keemo Paul', 'Vitel Lawes',
    'Hunain Shah',
]

NAME_MAP = {
    # Guyana Amazon Warriors
    'Haris': 'Mohammad Haris', 'Mohammad Haris': 'Mohammad Haris',
...
MATCH_INFO = {
    ...
    'city': 'Bridgetown',
    'dates': ['2026-09-18'],
    'event': {'name': 'Caribbean Premier League', 'match_number': 35, 'stage': 'Qualifier 2'},
    'gender': 'male',
    'match_type': 'T20',
    'outcome': {'winner': 'Jamaica Kingsmen', 'by': {'wickets': 5}},
    'overs': 20,
    'player_of_match': ['Rovman Powell'],
    'season': '2026',
    'team_type': 'club',
...
if __name__ == '__main__':
    out = os.path.join(_HERE, 'cpl_2026_match35_amazon_vs_kingsmen.json')
